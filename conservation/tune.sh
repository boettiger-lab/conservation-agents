...
python ../tuning/zoo_train.py   --algo a2c --env conservation-v5 -n 300000 -optimize \
  --n-trials 400 --n-jobs 4 --sampler random --pruner median \
  --storage sqlite:///tuning.db --study-name a2c-cons-v5 &

python ../tuning/zoo_train.py   --algo ppo --env conservation-v5 -n 300000 -optimize \
  --n-trials 400 --n-jobs 4 --sampler random --pruner median \
...
CUDA_VISIBLE_DEVICES="1" python ../tuning/zoo_train.py   --algo ddpg --env conservation-v5 -n 300000 -optimize \
  --n-trials 200 --n-jobs 1 --sampler random --pruner median \
