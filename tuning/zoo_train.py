...
if __name__ == "__main__":  # noqa: C901
    ...
    if env_id not in registered_envs:
        ...
        raise ValueError(printf("{env_id} not found in gym registry, you maybe meant {closest_match}?"))
    ...
    if args.num_threads > 0:
        if args.verbose > 1:
            printf("Setting torch.num_threads to {args.num_threads}")
