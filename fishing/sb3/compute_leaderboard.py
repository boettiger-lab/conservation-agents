...
model = PPO('MlpPolicy', env, verbose=0, tensorboard_log=tensorboard_log, device="cpu")
...
model = A2C('MlpPolicy', env, verbose=0, tensorboard_log=tensorboard_log, device="cpu")
model.learn(total_timesteps=300000)
mean_reward, std_reward = evaluate_policy(model, env, n_eval_episodes=100)
...
model = DDPG('MlpPolicy', env, verbose=0, tensorboard_log=tensorboard_log, device="cpu")
model.learn(total_timesteps=300000)
mean_reward, std_reward = evaluate_policy(model, env, n_eval_episodes=100)
