...
python zoo_train.py   --algo a2c --env fishing-v1 -n 300000 -optimize   --n-trials 400 --n-jobs 4 --sampler random --pruner median   --storage sqlite:///tuning.db   --study-name a2c-fishingv1
